...
var displaySearch = function displaySearch(obj) {
  ...
  result.forEach(function (item) {
    if (item.media_type === 'movie') {
      movie += "\n            <div class=\"template__wrapper\">\n                <img src=".concat(item.poster_path === null ? _poster_unavailable.default : imageBaseURL + item.poster_path, " class=\"search__movie--poster\" alt=\"\" />\n                <h4 class=\"search__movie--title\">").concat(item.title, "</h4>\n                <button class=\"more__details\">More details</button>\n            </div>");
...
var displayUpcomingMovies = function displayUpcomingMovies(obj) {
  ...
  fetch(movieById_URL).then(function (response) {
    ...
    var homepage = movieById.homepage; // returns string

    var runtime = movieById.runtime;
...
},{"./movieSearch.js":"js/movieSearch.js","./upcomingMovies.js":"js/upcomingMovies.js","./topRatedMovies.js":"js/topRatedMovies.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
